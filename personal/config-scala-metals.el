...
;;   Warning: on some systems this package can reduce your emacs responsiveness
;;   significally.
;;   (See: https://emacs-lsp.github.io/lsp-mode/page/performance/)
;;   In that case you have to not only disable this but also remove from
;;   the packages since lsp-mode can activate it automatically.
(use-package lsp-ui)

;; lsp-mode supports snippets, but in order for them to work you need to use
;; yasnippet
;; If you don't want to use snippets set lsp-enable-snippet to nil in your
;; lsp-mode settings to avoid odd behavior with snippets and indentation
